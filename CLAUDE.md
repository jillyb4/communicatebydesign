...
| **Picture Book Companions** | K–3 | **1 live (Apr 4 2026).** First product: All the Way to the Top — **LIVE on TPT. TPT ID: 15979429. Airtable: `recPx1oIQOMEUBP9E`.** Framework: IRA + Dialogic Reading + ALS. Research: `Research/Picture_Book_Companions_Research_Foundation.md`. Standards: RL.K-3.3 + RL.K-3.4. 3-reading structure. ALS one-pager embedded. Vocab ceiling: 15–20 words. Color: Dusty Rose-Coral #D4614E (locked Apr 3 2026). Symbol pages and comm board: Python/ReportLab ONLY (never inside .js build). Build scripts in `Products/Picture Book Companions/All the Way to the Top/`. |
