...
| **Fiction Line — Wonder** | Unit 1: Wonder: Character Analysis (RL.5.3/5.6, grades 3–8). **LIVE on TPT (Apr 2026).** TPT ID: 15945146. Price: $6.00 LOCKED. Airtable: `reccsVcc4bkuaiIJ9` (Live ✓). File set: COMPLETE.docx + COMPLETE.pdf + Printable_Packet.pdf (13pp) + FULL.pdf assembled. Symbol subs LOCKED: belong→include, ordinary→usual, face→face. Annotation codes LOCKED: [TRAIT]/[WHY]/[CHANGE]. Rubric not yet built. **Confirmed 6-unit launch set in Airtable.** Bundle: pair w/ The Giver when Unit 2 launches (May). | — |
...
- **PDF generation:** Word → File → Save As → PDF (not Print to PDF, not LibreOffice) — applies to nonfiction units, fiction units, and poetry units. **Exception: Picture Book Companions** use LibreOffice headless conversion (verified clean Apr 4 2026 — fonts and layout intact).
