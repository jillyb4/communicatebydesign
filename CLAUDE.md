...
**Products table covers:** AT/AAC IEP Team (7), AT/AAC Family (6), Nonfiction (7), UFLI Phonics (4), Bundle (3), Trading Cards (5), Picture Book Companions (1), Fiction Anchor Texts (1), Poetry Reading Units (1) = 35 product records
...
| **Picture Book Companions** | K–3 | **1 live (Apr 4 2026). 5 in build (Apr 4 2026).** First product: All the Way to the Top — **LIVE on TPT. TPT ID: 15979429. Airtable: `recPx1oIQOMEUBP9E`.** Framework: IRA + Dialogic Reading + ALS. Research: `Research/Picture_Book_Companions_Research_Foundation.md`. Pipeline research: `Research/CbD_PictureBook_Pipeline_Research.md` (28 titles, SEO analysis, priority scoring). Standards: RL.K-3.3 + RL.K-3.4. 3-reading structure. ALS one-pager embedded. Vocab ceiling: 15–20 words. Color: Dusty Rose-Coral #D4614E (locked Apr 3 2026). Symbol pages and comm board: Python/ReportLab ONLY (never inside .js build). **Build queue (Apr 4 2026):** A Friend for Henry (K–1, RL.K.3–RL.1.3, belonging/autism) · I Talk Like a River (K–2, RL.K.3–RL.2.3, communication identity) · Ian's Walk (K–1, RL.K.3–RL.1.3, perspective/sensory) · Emmanuel's Dream (1–2, RL.1.3+RI.1.3, biography/persistence) · My Friend Isabelle (K–1, RL.K.3–RL.1.3, friendship/Down syndrome). All five have `build_symbol_pages_picbook.py` built. SEO gap confirmed: zero TPT competition for all 5 titles. Build scripts in each title's folder under `Products/Picture Book Companions/`. **Canva bulk import CSV:** `Distrubution/Pinterest/PB_Companions_Canva_BulkImport.csv` — 6 rows (all companions), 8 columns (book_title, series_label, skill_focus, skill_short, standards, grade_band, hook_text, tpt_tag). |
...
│   ├── Picture Book Companions/ (All the Way to the Top/ — build_all_the_way_to_the_top.js + build_symbol_pages_picbook.py + build_welcome_packet.py)
