...
| **Poetry Reading Units** | — | 0 live. NEW product line est. 2026-03-30. Grades 6–10. 4-unit Phase 1 pipeline in Airtable. **Architecture: access-layer model** (same poem across V1/V2/V3 — NOT text-versioned). CbD-original strategy: **NOTICE/FEEL/MEAN/ASK (NFMA)**. Price: $9.95/unit. Cadence: every 2 months starting May 2026. ⚠️ 5 pre-build gates must pass before Unit 1 build: color locked · Research Foundation doc · Vocabulary Framework Section 4f · Differentiation reference poetry exception · poem selection + copyright confirmed. Initial build plan: `Research/CbD_Poetry_Unit_Line_Initial_Build_Plan.md`. |
