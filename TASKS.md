...
- [ ] **Poetry Unit 1: Rebuild Student Packet (b&w, printable)** — Current `build_poetry_student_packet.py` uses too much color; does not match CbD student activity standard. Must be rebuilt to match nonfiction/fiction student handout conventions: b&w printable, structured activity layout (not design-heavy). See `_Operations/memory/build_system_reference.md` Student Packet Standards section. *(Added 2026-04-02)*
...
- [ ] **Poetry Unit 1: GitHub push** — Commit `build_poetry_student_packet.py`, `build_poetry_cap.py`, `build_poetry_session_tracker.py` + updated `_Operations/memory/build_system_reference.md` + `_Operations/memory/communication_access_reference.md`. Open GitHub Desktop → commit → push. *(Added 2026-04-02)*
