...
### TPT Taxonomy in Airtable — Manual Actions Required (2026-04-12)
- [ ] **⚠️ Airtable: Delete old TPT Tags field (singleLineText)** — Field `fldA8BMhXXrDkrjji` "TPT Tags" is a plain text field and cannot hold dropdown choices. New field `fldGl1bOucir0OQZO` "TPT Tags (NEW)" created with 129 exact TPT dropdown values. In Airtable: delete the old "TPT Tags" field → rename "TPT Tags (NEW)" → "TPT Tags." *(Added 2026-04-12)*
- [ ] **⚠️ Airtable: Fix TPT Subject Areas field** — Field `fldDXxOjBk4YZJyfF` still has invented values (English Language Arts, Special Education, Speech Therapy, Life Skills, Social Skills, Phonics, Vocabulary) that don't exist in TPT's dropdown. In Airtable field settings: delete those bad choices, keep Reading/Literature/Writing, add the missing verified options (Poetry, U.S. History, Native Americans, Environment, Social Emotional Learning, Not Subject Specific, For All Subjects, and all other verified subject options from TPT screenshots). *(Added 2026-04-12)*
- [ ] **⚠️ Airtable: Populate TPT Tags (NEW) for all 23 products** — Now that the field exists with correct choices, open each product record and select the Tags per the Tag Grid: `Distrubution/Teachers Pay Teachers/CbD_TPT_Tag_Grid.html`. *(Added 2026-04-12)*
- [ ] **⚠️ Airtable: Populate TPT Subject Areas for all 23 products** — Once bad choices are removed, select correct Subject Areas per the Tag Grid for each product record. *(Added 2026-04-12)*
- [ ] **⚠️ Airtable: Populate TPT Format for all 23 products** — Field `fldB9lPPVDht1pW8D` is correctly built. Most products = Microsoft: Microsoft Word + PDF. UFLI = Google Apps. Use Tag Grid for reference. *(Added 2026-04-12)*
- [ ] **⚠️ TPT: Delete 8 bad Custom Categories** — In TPT Custom Categories manager, delete: Auditory Confirmation Loop · Multi-Access Response Design · Partner Scripting Tools · Fringe Vocabulary Focus · Core Vocabulary Focus · Presumed Competence · PreK-Kindergarten · Students in Early Intervention (PreK-K). *(Added 2026-04-12)*
