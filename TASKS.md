...
- [ ] **Run `sync_vocab_to_airtable.js` after Poetry Unit 1 lists** — Script now handles Poetry Reading Unit and Picture Book Companion product lines + skips pendingBuild stubs. Run AFTER Poetry Unit 1 TPT listing is complete, not before. *(Added 2026-04-03)*
- [ ] **GitHub push — Sessions 21–24 code changes** — Open GitHub Desktop → commit → push origin. Files changed: `_Operations/Build/sync_vocab_to_airtable.js` (pendingBuild skip + Poetry/PictureBook product line routing + UNIT_TITLE_MAP additions), `_Operations/Build/cbd_unit_vocab.js` (Poetry Unit 1 words, Picture Book Companion words, Fiction stubs Units 2–6), `_Operations/Dashboards/CbD_Launch_Dashboard.html`, `CbD_Task_Dashboard.html`, `CbD_Workflow_Visual.html` (nav fixes), `_Operations/Dashboards/CbD_Vocabulary_Dashboard.html` (NEW), `Products/Fiction Anchor Texts/Wonder - Character Analysis/build_wonder_printable_packet.py`, `build_wonder_assembly.py`. *(Updated 2026-04-03)*
